	...
	return (
		<section className="mt-16 min-h-[70vh] bg-no-repeat bg-cover bg-center flex items-center justify-center bg-aboutHero relative">
			...
			<div className="px-6 max-w-desktop mx-auto text-center text-white z-10 xl:px-0">
				<h1 className="text-4xl md:text-50 leading-130 font-bold mt-32 mb-2 ">About Us</h1>
				<p className="md:text-xl max-w-[838px] mx-auto">
				...
				<div className="mt-8 flex items-center justify-center">
					<button className="text-lg flex items-center justify-center gap-3 py-4 px-5 hover:bg-yellow rounded-[10px]">
