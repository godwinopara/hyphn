export default function ContentHero() {
	return (
		<section className="mt-16 min-h-[60vh] md:min-h-[30vh] lg:min-h-[50vh] bg-no-repeat bg-cover bg-bottom flex items-center justify-center bg-contentVaultBg relative">
